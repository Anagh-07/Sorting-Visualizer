...
function quick_partition(start, end) {
  ...
  for (var j = start + 1; j <= end; j++) {
    if (unsorted_array[j] < piv) {
      ...
      update_bar(bars_array[i], unsorted_array[i], "#00ff99"); //Color update
      update_bar(bars_array[j], unsorted_array[j], "#00ff99"); //Color update
      ...
      update_bar(bars_array[i], unsorted_array[i], "#00ff99"); //Height update
      update_bar(bars_array[j], unsorted_array[j], "#00ff99"); //Height update
  ...
  update_bar(bars_array[start], unsorted_array[start], "#00ff99"); //Color update
  update_bar(bars_array[i - 1], unsorted_array[i - 1], "#00ff99"); //Color update
  ...
  update_bar(bars_array[start], unsorted_array[start], "#00ff99"); //Height update
  update_bar(bars_array[i - 1], unsorted_array[i - 1], "#00ff99"); //Height update
